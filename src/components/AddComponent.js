...
const AddComponent = () => {
    ...
    const userSubmit = async (formdata) => {
        ...
        const response = await fetch('http://localhost:5000/user/addcomponent', {
            method: 'POST',
            ...
            <div className="container pt-5">
                <div className="card">
                    <div className="card-body">
                        <Formik
                            initialValues={{ title: '', code: '', thumbnail: '', uploadedBy: '', createdAt: new Date() }}
                            onSubmit={userSubmit}>
                            {({ values, handleSubmit, handleChange }) => (
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <input className='form-control' id="thumbnail" onChange={handleChange} value={values.thumbnail} />
